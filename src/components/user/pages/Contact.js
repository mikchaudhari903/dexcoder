  ...
  return (
    ...
    <Header />
      <section id="contact" className="contact section">
        ...
        <div className="container position-relative aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="row gy-4">
            ...
            <div className="col-lg-7">
              <form action="forms/contact.php" method="post" className="php-email-form aos-init aos-animate" data-aos="fade-up" data-aos-delay="500">
                <div className="row gy-4">
